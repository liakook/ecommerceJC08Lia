        ...
        .map((val) => {
            return (
                <TableRow key={val.id}>
                    ...
                    <TableCell>
                    <Button onClick={()=>this.onBtnEditClick(val)} animated color='orange'>
                    <Button.Content visible>Edit</Button.Content>
                    <Button.Content hidden>
                        <Icon name='edit' />
                    </Button.Content>
                    </Button>
                    <Button animated color='light-purple' onClick={()=> this.onBtnDelete(val.id)}>
                  ...
                  <TableBody>
                      <TableRow>
                          <TableCell>
                            ...
                            <Button animated color='teal' className='mt-2 ml-2 mb-2' onClick={this.onBtnAdd}> {/*  ini library punya Semantic ui */}
                  ...
                  <TableBody>
                      <TableRow>
                          <TableCell>
                            ...
                            <Button animated color='teal' className='mt-2 ml-2 mb-2' onClick={this.onBtnSave}> {/*  ini library punya Semantic ui */}
                            ...
                            <Button animated color='teal' className='mt-2 ml-2 mb-2' onClick={this.onBtnCancel}> {/*  ini library punya Semantic ui */}
